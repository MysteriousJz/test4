...
# Binary mask categories for the switchboard UI (58 masks).
# Covers all signals generated by aa.py:
#   PHI Crossovers (8), CRAP Alignment (2), Price Percentile (8),
#   Price Extreme (2), CRAP Percentile (8), CRAP Extreme (2), PHI Entry/Exit (4).
MASK_CATEGORIES = {
    "PHI Gates (2)": [
    ...
    "PHI Entry/Exit (4)": [
        ("PRICE_ENTERS_LOWEST_PHI",  "Price enters lowest PHI zone"),
        ("PRICE_EXITS_LOWEST_PHI",   "Price exits lowest PHI zone"),
        ("PRICE_ENTERS_HIGHEST_PHI", "Price enters highest PHI zone"),
        ("PRICE_EXITS_HIGHEST_PHI",  "Price exits highest PHI zone"),
    ],
    "RSI Pulse (2)": [
...
MASK_COLORS = {
    ...
    # PHI Entry/Exit (enters lowest = buy/green, exits lowest = sell/red; inverted for highest)
    "PRICE_ENTERS_LOWEST_PHI":  "#00DDCC",   # teal-green (entering support = buy)
    "PRICE_EXITS_LOWEST_PHI":   "#DD4400",   # burnt orange (leaving support = sell)
    "PRICE_ENTERS_HIGHEST_PHI": "#DD0044",   # deep rose (entering resistance = sell)
    "PRICE_EXITS_HIGHEST_PHI":  "#00CCAA",   # green-teal (exiting resistance = buy)
}
...
BUY_MASKS = {
    ...
    # Price extreme oversold (buy side)
    "EXTREME_OVERSOLD",
    # CRAP percentile bottoms (buy side)
    "CRAP_BOTTOM_5H", "CRAP_BOTTOM_9H", "CRAP_BOTTOM_14H", "CRAP_BOTTOM_24H",
    # CRAP extreme low (buy side)
    "CRAP_EXTREME_LOW",
    # PHI Entry/Exit buy-side signals
    "PRICE_ENTERS_LOWEST_PHI", "PRICE_EXITS_HIGHEST_PHI",
    # RSI / THETA (buy side)
...
class PrototypeUI(BoxLayout):
    ...
    def __init__(self, **kw):
        ...
        # --- Binary Mask Switchboard (58 masks) ---
        lc.add_widget(Label(
            text='[b]Binary Mask Toggles (58)[/b]', markup=True,
