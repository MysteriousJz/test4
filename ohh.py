...
# Includes all 40 masks generated by aa.py plus 18 extended signals:
...
MASK_CATEGORIES = {
    ...
    "CRAP Breath Level (8)": [
        ("CRAP5_7_U",   "CRAP_5_7 ≥ threshold (overbought)"),
        ("CRAP9_2_U",   "CRAP_9_2 ≥ threshold (overbought)"),
        ("CRAP14_8_U",  "CRAP_14_8 ≥ threshold (overbought)"),
        ("CRAP24_U",    "CRAP_24 ≥ threshold (overbought)"),
        ("CRAP5_7_D",   "CRAP_5_7 ≤ −threshold (oversold)"),
        ("CRAP9_2_D",   "CRAP_9_2 ≤ −threshold (oversold)"),
        ("CRAP14_8_D",  "CRAP_14_8 ≤ −threshold (oversold)"),
        ("CRAP24_D",    "CRAP_24 ≤ −threshold (oversold)"),
    ],
    "CRAP Breath Momentum (8)": [
        ("CRAP5_7_MU",   "CRAP_5_7 rising"),
        ("CRAP9_2_MU",   "CRAP_9_2 rising"),
        ("CRAP14_8_MU",  "CRAP_14_8 rising"),
        ("CRAP24_MU",    "CRAP_24 rising"),
        ("CRAP5_7_MD",   "CRAP_5_7 falling"),
        ("CRAP9_2_MD",   "CRAP_9_2 falling"),
        ("CRAP14_8_MD",  "CRAP_14_8 falling"),
        ("CRAP24_MD",    "CRAP_24 falling"),
    ],
    "CRAP Peak/Trough (8)": [
...
BUY_MASKS = {
    ...
    # CRAP level below oversold threshold (buy side)
    "CRAP5_7_D", "CRAP9_2_D", "CRAP14_8_D", "CRAP24_D",
    # CRAP momentum rising (buy side)
